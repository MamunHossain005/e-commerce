  ...
  extraReducers: (builder) => {
    builder.addCase(fetchProductsByFilters.pending, (state) => {
      ...
      state.error = null;
        ...
        state.loading = false;
        state.selectedProduct = action.payload; // ✅ Fixed: Use selectedProduct instead of products
      ...
      state.error = null;
        ...
        state.loading = false;
        state.similarProducts = Array.isArray(action.payload) ? action.payload : []; // ✅ Added safety check
