...
const AddProductPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Parse the input strings before validation
    const finalSizes = sizesInput
      .split(",")
      .map((size) => size.trim())
      .filter((size) => size !== "");
    const finalColors = colorsInput
      .split(",")
    ...
    // Update productData with the parsed values
    ...
    // Validation using the updated data
    if (!updatedProductData.name.trim()) {
    ...
    if (!updatedProductData.sku.trim()) {
    ...
    if (!updatedProductData.category.trim()) {
      setSubmitError("Category is required");
      return;
    }
    if (finalSizes.length === 0) {
      setSubmitError("At least one size is required");
      return;
    }
    if (finalColors.length === 0) {
      setSubmitError("At least one color is required");
      return;
    }
    if (!updatedProductData.collections.trim()) {
      setSubmitError("Collection is required");
      return;
    }
    ...
    try {
      const resultAction = await dispatch(
        createProduct({
          ...updatedProductData,
          countInStock: updatedProductData.countInStock,
        }) as any
      );
      ...
      if (createProduct.fulfilled.match(resultAction)) {
        ...
        const errorMessage = resultAction.payload || "Failed to create product";
    ...
    <div className="max-w-5xl mx-auto p-6 shadow-md rounded-md bg-white">
        ...
        <div className="mb-8">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onBlur={() => {
                // Update the actual sizes array when the input loses focus
                setProductData((prev) => ({
                  ...prev,
                  sizes: sizesInput
                    .split(",")
            ...
            <p className="text-sm text-gray-500 mt-1">
              Separate sizes with commas. At least one size is required.
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onBlur={() => {
                // Update the actual colors array when the input loses focus
                setProductData((prev) => ({
                  ...prev,
                  colors: colorsInput
                    .split(",")
            ...
            />
            <p className="text-sm text-gray-500 mt-1">
              Separate colors with commas. At least one color is required.
            </p>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onBlur={() => {
                // Update the actual tags array when the input loses focus
                setProductData((prev) => ({
                  ...prev,
                  tags: tagsInput
                    .split(",")
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          ...
          <li>• SKU should be unique - use the generate button if unsure</li>
          <li>• Add multiple high-quality images to showcase your product</li>
          <li>
            • Detailed descriptions help customers make informed decisions
          </li>
          <li>• Keep stock quantities accurate for inventory management</li>
        </ul>
      </div>
    </div>
  );
